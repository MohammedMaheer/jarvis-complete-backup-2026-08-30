...
function WizardContent({ skipToAccount }: { skipToAccount?: boolean }) {
  ...
  return (
    <div className="jarvis-workspace flex min-h-screen items-center justify-center bg-[var(--color-background)] p-4 sm:p-8">
      <div className="w-full max-w-3xl">
        <div className="mb-7 flex items-center justify-center gap-3">
          <span className="jarvis-orb h-10 w-10 text-white"><AudioWaveform size={18} /></span>
          <div>
            <p className="text-sm font-bold tracking-[0.22em] text-[var(--color-text)]">JARVIS</p>
            <p className="text-[10px] uppercase tracking-[0.15em] text-[var(--color-text-muted)]">Private assistant initialization</p>
          </div>
        </div>
        {/* Step indicator */}
        ...
        {/* Step content */}
        <div className="jarvis-panel p-5 sm:p-7">
          <StepComponent />
        </div>
