...
class TestLengthAdaptiveThreshold:
    def test_short_clip_uses_short_threshold(self, monkeypatch):
        ...
        assert utils_mod._pick_threshold(2.0) == 0.4    # normal
        assert utils_mod._pick_threshold(5.0) == 0.34   # long
        assert utils_mod._pick_threshold(0.0) == 0.4    # unknown/zero duration → normal
