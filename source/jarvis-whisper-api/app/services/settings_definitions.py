...
SETTINGS_DEFINITIONS: list[SettingDefinition] = [
    ...
    SettingDefinition(
        ...
        description=(
            ...
            "This local ECAPA profile is calibrated to 0.40; tune empirically "
            "using scripts/benchmark_speaker_encoders.py."
        ),
    ),
    SettingDefinition(
    ...
    SettingDefinition(
        ...
        default=0.34,
        description=(
            "Relaxed calibrated threshold applied to long clips (duration > "
